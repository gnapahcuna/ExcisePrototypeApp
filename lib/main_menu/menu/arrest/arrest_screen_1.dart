...
class _ArrestMainScreenFragmentState extends State<ArrestMainScreenFragment>  with TickerProviderStateMixin {
  ...
  List<ItemsListArrest6Section> _itemsInitTab6Init = [
    new ItemsListArrest6Section("ฐานความผิดมาตรา 191", "ขายสุราที่ผลิตขึ้นโดยฝ่าฝืนมาตรา 153 วรรคหนึ่ง",[
      new ItemsListArrest6Suspect("นายเสนาะ อุตโม",2,false),
      new ItemsListArrest6Suspect("นายวสันต์ ศรีสุข",4,false),
      new ItemsListArrest6Suspect("นางสาวแค๊ปเฌอ อารี",5,false)
  ...
  void onSaved()async {
    ...
    setState(() {
      ...
      _itemsDataTab7.add(ItemsListArrest7(Behavior, Testimony, NotificationOfRights));

      _itemsDataTab8.add(ItemsListArrest8("แบบฟอร์มบันทึกการจับ 2/39"));
      _itemsDataTab8.add(ItemsListArrest8("รายละเอียดการกระทำผิดของผู้กระทำผิด"));
      //tabController.animateTo((choices.length-1));
                  ...
                  child: Column(
                    ...
                    children: <Widget>[
                        ...
                        children: <Widget>[
                          Expanded(
                            child: Padding(
                              padding: paddingInputBox,
                              child: Text(
                                _itemsDataTab2[index].NumberValue,
                                style: textDataStyle,),
                            ),
                          ),
                          Center(
                      ...
                      Container(
                        padding: paddingLabel,
                        child: Text(
                          "ผู้รับแจ้งความ "+_itemsDataTab2[index].NameInformant, style: textDataStyleSub,),
                      ),
                    ],
                  ),
                ),
...
//************************start_tab_4*******************************
                      ...
                      Row(
                        children: <Widget>[
                          Expanded(
                            child: Container(
                              padding: paddingLabel,
                              child: Text(_itemsDataTab4[index].NameTitle + ' ' +
                          ...
                          Center(
                              child: InkWell(
                                ...
                                child: Container(
                                    child: Text("ลบ", style: textLabelDeleteStyle,)
                                ),
                              )
                          ),
                        ],
                      ...
                      Padding(
                        ...
                        child: Text(
                          "จำนวนครั้งการกระทำผิด " +
                              _itemsDataTab4[index].OffenseCount.toString() + " ครั้ง",
  ...
  _navigateScreenEditTab5(BuildContext context) async {
    final result = await Navigator.push(
      context,
      MaterialPageRoute(builder: (context) => TabScreenArrest5Edit(ItemsData: _itemsDataTab5,)),
    );
    setState(() {
      _itemsDataTab5 = result;
    });
                            ...
                            Container(
                              ...
                              child: Column(
                                ...
                                children: <Widget>[
                                  ...
                                  Container(
                                    padding: paddingLabel,
                                    child: Text(_itemsDataTab5[index].Counts.toString(),
                                      style: textInputStyle,),
                                  ),
                                ],
                              ),
                            ...
                            Container(
                              ...
                              child: Column(
                                ...
                                children: <Widget>[
                                  ...
                                  Container(
                                    padding: paddingLabel,
                                    child: Text(_itemsDataTab5[index].CountsUnit,
                                      style: textInputStyle,),
                                  ),
                                ],
                              ),
                            ...
                            Container(
                              ...
                              child: Column(
                                ...
                                children: <Widget>[
                                  ...
                                  Container(
                                    padding: paddingLabel,
                                    child: Text(_itemsDataTab5[index].Volume.toString(),
                                      style: textInputStyle,),
                                  ),
                                ],
                              ),
                            ...
                            Container(
                              ...
                              child: Column(
                                ...
                                children: <Widget>[
                                  ...
                                  Container(
                                    padding: paddingLabel,
                                    child: Text(_itemsDataTab5[index].VolumeUnit,
                                      style: textInputStyle,),
                                  ),
                                ],
                              ),
  ...
  _navigateEditSelection(BuildContext context,String title,String detail,items) async {
    final result = await Navigator.push(
      context,
      MaterialPageRoute(builder: (context) => TabScreenArrest6Section(Title: title,Detail: detail,ItemsSuspect: items)),
    );
      ...
      return new Container(
        ...
        child: ListView.builder(
          ...
          itemBuilder: (BuildContext context, int index) {
            return InkWell(
                onTap: (){
                  IsSelected_tab6?null:_navigateSelection(context,_itemsInitTab6[index].SectionName,_itemsInitTab6[index].SectionDetail,_itemsInitTab6[index].ItemSuspect);
                },
                child: Padding(
                        ...
                        Column(
                          ...
                          children: <Widget>[
                            Row(
                              children: <Widget>[
                                Expanded(
                                  child: Container(
                                    padding: paddingLabel,
                                    child: Text(_itemsInitTab6[index].SectionName,
                                      style: textInputStyleTitle,),
                                  ),
                                ),
                                IsSelected_tab6?Column(
                                  children: <Widget>[
                                    Center(
                                        child: InkWell(
                                          onTap: () {
                                            _navigateEditSelection(context,_itemsInitTab6[index].SectionName,_itemsInitTab6[index].SectionDetail,_itemsInitTab6[index].ItemSuspect);
                                          },
                                          child: Container(
                                              child: Text("แก้ไข", style: textLabelEditNonCheckStyle,)
                                          ),
                            ...
                            Row(
                              ...
                              mainAxisAlignment: MainAxisAlignment.end,
                              children: <Widget>[
                                !IsSelected_tab6?Icon(Icons.arrow_forward_ios,color: Colors.grey[300],size: 18,):Container(),
                              ],
                            ),
                            Row(
                              children: <Widget>[
                                Expanded(
                                  child: Padding(
                                    padding: paddingInputBox,
                                    child: Text(
                                      _itemsInitTab6[index].SectionDetail,
                                      style: textInputStyleSub,),
                                  ),
                                ),
                          ...
                          child: Column(
                            ...
                            children: <Widget>[
                              ...
                              Container(
                                ...
                                child: Text(
                                  _itemsDataTab7[index].Behavior, style: textInputStyle,),
                              ),
                              Padding(
                                padding: paddindTextTitle,
                                child: Text(
                              ...
                              Container(
                                padding: EdgeInsets.all(12.0),
                                child: Text(
                                  _itemsDataTab7[index].Testimony, style: textInputStyle,),
                              ),
                              Padding(
                                padding: paddindTextTitle,
                                child: Text(
                              ...
                              Container(
                                padding: EdgeInsets.all(12.0),
                                child: Text(
                                  _itemsDataTab7[index].NotificationOfRights, style: textInputStyle,),
                              )
                            ],
                          )
                      ),
              ...
              itemBuilder: (BuildContext context, int index) {
                return Padding(
                  ...
                  child: Container(
                    ...
                    child: ListTile(
                        title: Text((index+1).toString()+'. '+_itemsDataTab8[index].FormsName,
                          style: textInputStyleTitle,),
                        trailing: Icon(Icons.arrow_forward_ios,color: Colors.grey[300],),
                        onTap: () {
                          Navigator.push(
                            context,
                            MaterialPageRoute(builder: (context) => TabScreenArrest8Dowload(Title: _itemsDataTab8[index].FormsName,)),
                          );
                        }
                    ),
                  ),
